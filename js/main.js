	...
	$(document.body).on('appear', '.animateright', function(e, $affected) {
	  ...
	  $(document.body).on('appear', '.countup', function(e, $affected) {
			...
			// Count up javascript
				...
				var demo1 = new countUp("counting_elem1", 0, 2000, 0, 2, options);
				demo1.start();
				var demo2 = new countUp("counting_elem2", 0, 5000, 0, 2, options);
				demo2.start();
				var demo3 = new countUp("counting_elem3", 0, 35890, 0, 2, options);
				demo3.start();
